...
function p(e2, a2) {
  ...
  m2.graphite = n({ scope: { state: l2, fn: h2 }, node: [_e((e3, t2, r2) => (r2.scope && !r2.scope.reg[l2.id] && (r2.b = 1), e3)), Pe(l2), _e((e3, t2, { a: r2, b: a3 }) => !$e(e3) && (e3 !== r2 || a3), 1), h2 && Le(Ie, 1), Fe({ from: P, target: l2 })], child: s2, meta: { ...g2, defaultState: e2 }, regional: 1 }), K(m2, "id", m2.graphite.id), K(m2, "rootStateRefId", f2);
...
function x(...e2) {
  ...
  return $e(o2) && Me(i2) && M(i2, "sample") && (o2 = i2.clock, l2 = i2.fn, d2 = !i2.greedy, n2 = i2.filter, t2 = i2.target, r2 = i2.name, a2 = i2.sid, i2 = i2.source), Ft("sample", o2, i2, n2, t2, l2, r2, s2, d2, 1, 0, a2);
}
function $(...e2) {
  let [[t2, r2], a2] = f(e2);
  return r2 || (r2 = t2, t2 = r2.source), M(r2, "guard"), Ft("guard", r2.clock, t2, r2.filter, r2.target, null, r2.name, a2, !r2.greedy, 0, 1);
}
function z(t2, r2, a2) {
  if (Z(t2))
...
function j(...t2) {
  ...
  if (m2 || g2)
    m2 && b2.add(s2), y2 = [m2 && Pe(W(s2), 0, 1), Re({ safe: m2, filter: 1, pure: !m2, fn(e2, t3, r2) {
  ...
  if (i2 && Ft(o2, i2, l2, null, k2, null, o2, c2, 0, 0, 0), !p2)
    return a2;
}
...
function O(e2, a2) {
  ...
  let l2 = ((e3) => {
    ...
    }), Re({ priority: "sampler", batch: 1 }), _e((e4, r3) => {
...
var De = 0;
var Fe = ({ from: e2 = "store", store: t2, target: r2, to: a2 = r2 ? "store" : P, batch: n2, priority: i2 }) => Ne("mov", { from: e2, store: t2, to: a2, target: r2 }, i2, n2);
var Re = ({ fn: e2, batch: t2, priority: r2, safe: a2 = 0, filter: n2 = 0, pure: i2 = 0 }) => Ne("compute", { fn: e2, safe: a2, filter: n2, pure: i2 }, r2, t2);
var Ee = ({ fn: e2 }) => Re({ fn: e2, priority: "effect" });
var _e = (e2, t2, r2) => Re({ fn: e2, safe: 1, filter: t2, priority: r2 && "effect" });
var Pe = (e2, t2, r2) => Fe({ store: e2, to: t2 ? P : "a", priority: r2 && "sampler", batch: 1 });
var Le = (e2 = qe, t2) => Re({ fn: e2, pure: 1, filter: t2 });
var Te = { mov: Fe, compute: Re, filter: ({ fn: e2, pure: t2 }) => Re({ fn: e2, filter: 1, pure: t2 }), run: Ee };
...
var pt = (e2, r2, a2, n2, i2) => {
  var o2;
  let l2 = e2.reg, s2 = r2.sid, f2 = null == r2 || null === (o2 = r2.meta) || void 0 === o2 ? void 0 : o2.serialize, d2 = e2.fromSerialize && "ignore" !== f2 && (null == f2 ? void 0 : f2.read) || ct;
  if (l2[r2.id])
    return;
...
var jt = (e2, t2, r2, a2, n2) => {
  let i2 = W(t2), o2 = Fe({ store: i2, to: "a", priority: "read" });
...
var Ct = (t2, a2, n2, i2, l2) => {
  ...
  let b2 = [_e((e2, t3, r2) => (r2.scope && !r2.scope.reg[c2.id] && (r2.c = 1), e2)), y2, Fe({ store: m2, to: "b" }), _e((e2, { key: t3 }, r2) => {
    if (r2.c || e2 !== r2.a[t3])
      return a2 && r2.b && (r2.a = s2(r2.a)), r2.a[t3] = e2, 1;
  }, 1), Fe({ from: "a", target: c2 }), Fe({ from: "value", store: 0, target: m2 }), Fe({ from: "value", store: 1, target: m2, priority: "barrier", batch: 1 }), Pe(c2, 1), l2 && Le()];
  return e(n2, (e2, t3) => {
    if (!Z(e2))
      return r(!X(e2) && !$e(e2), `combine expects a store in a field ${t3}`), void (u2[t3] = f2[t3] = e2);
    f2[t3] = e2.defaultState, u2[t3] = e2.getState();
    let a3 = wt(e2, g2, b2, "combine", l2);
    a3.scope.key = t3;
    let n3 = W(e2);
...
var Ft = (e2, t2, a2, n2, i2, o2, l2, s2, f2, c2, g2, h2) => {
  let y2 = !!i2;
  ...
  let [M2, x2] = Et(a2, i2, t2, k2, e2), $2 = wt(t2, i2, [d("sampleSourceLoader"), Fe({ from: P, target: k2 }), ...Rt(x2), Pe(M2, 1, f2), ...w2, Pe(k2), "fn" === v2 && Le((e3, t3, { a: r2 }) => n2(e3, r2), 1), o2 && Le(Ie), d("sampleSourceUpward", y2)], e2, o2);
  return we(a2, [$2]), Object.assign($2.meta, s2, { joint: 1 }), i2;
};
var Rt = (e2) => [Pe(e2), _e((e3, t2, { a: r2 }) => r2, 1)];
var Et = (e2, t2, r2, a2, i2) => {
  let o2 = Z(e2), l2 = o2 ? W(e2) : Be(), s2 = Be(o2);
  return o2 || n({ parent: e2, node: [Fe({ from: P, target: l2 }), Fe({ from: "value", store: 1, target: s2 })], family: { owners: [e2, t2, r2], links: t2 }, meta: { op: i2 }, regional: 1 }), d("sampleSource", s2, l2, a2), [l2, s2];
};
var _t = (e2, t2, r2, a2) => {
  let n2 = e2[t2];
...
//# sourceMappingURL=chunk-3WSWMCQG.js.map
